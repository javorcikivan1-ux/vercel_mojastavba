...
const REASONS = [
  ...
  },
  {
    ...
    desc: "Vedenie elektronického denníka práce Vám ušetrí čas a zjednoduší prácu. Ponúka automatický import vykonaných prác z dochádzky, fotodokumentáciu a mnoho ďalšieho.",
    color: "from-orange-400 to-orange-600",
    theme: "rgba(249, 115, 22, 0.03)",
    preview: "Diary",
