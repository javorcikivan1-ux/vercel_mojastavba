                ...
                <div className="absolute bottom-16 right-4 w-72 md:w-80 bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.25)] border border-slate-100 overflow-hidden animate-in zoom-in-95 slide-in-from-right-4 duration-300 pointer-events-auto">
                    <div className="p-5 flex justify-between items-start border-b border-slate-50 bg-slate-50/50">
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Sme tu pre vás</p>
                        </div>
                    ...
                    <div className="p-5 space-y-6">
                        <div className="space-y-1">
                            ...
                            <p className="text-[10px] text-slate-400 font-medium italic">Po - Pi | 08:00 - 16:30</p>
                        </div>

                        <div className="relative py-1">
                            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-slate-100"></div></div>
                            <div className="relative flex justify-center"><span className="bg-white px-3 text-[9px] font-black text-slate-200 uppercase tracking-[0.2em]">alebo nám napíšte</span></div>
                        </div>
                        ...
                        {sent ? (
                            ...
                            <form onSubmit={handleSend} className="space-y-3">
                                {error && <div className="p-2 bg-red-50 text-red-600 text-[9px] rounded-lg border border-red-100">{error}</div>}
                                <textarea 
                                    ...
                                    placeholder="Popíšte stručne váš problém..."
                                    value={message}
